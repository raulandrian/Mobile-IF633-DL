package umn.ac.id.week07b_31733;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void isiDaftarVideo(){
        ...
        daftarVideo.add(new SumberVideo("Kejar-kejaran", "Kejar-kejaran di jalanan hasil cuplikasi dari film The Fast and The Furious", "android.resource://" +getPackageName() + "/"+ R.raw.drift02));
