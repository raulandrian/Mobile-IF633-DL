        ...
        dataCall.enqueue(new Callback<ArrayList<Data>>() {
            ...
            public void onResponse(@NonNull Call<ArrayList<Data>> call, @NonNull Response<ArrayList<Data>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Snackbar.make(mainLayout, getString(R.string.fetch_success), Snackbar.LENGTH_LONG).show();
                } else {
                    Snackbar.make(mainLayout, getString(R.string.request_fail), Snackbar.LENGTH_LONG).show();
                }
            }
