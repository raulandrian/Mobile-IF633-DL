...
public class Week10BActivity extends AppCompatActivity implements
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<Week10BActivity> mActivity;
        int mCounter = 0;
        public ContohLoader(@NonNull Context context, int n,
                            Week10BActivity main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<Week10BActivity>(main);
        }
        @Nullable
        @Override
